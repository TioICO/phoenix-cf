...
void Menu::Render(LPDIRECT3DDEVICE9 device)
{
	...
	DrawBox(10, 10, 190, 200, 0xC0000000, COLOR_RED, device);
	DrawBorder(10, 10, 190, 25, 1, COLOR_RED, device);
	...
	for (int32_t i = 0; i < this->num_items_; i++)
	{
		...
		WriteText(190, 40 + i * 20, color, status_desc, DT_RIGHT, this->font_);
	}
}
